...
public class ContinuousPeaks {
    ...
    public static void main(String[] args) {
        ...
        int[] iters = {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024};
        //int[] iters = {10};
        int testRuns = 3;
        ...
        for (int iter : iters) {
            ...
            for (int j = 0; j < testRuns; j++) {
                ...
                start = System.nanoTime();
                SimulatedAnnealing sa = new SimulatedAnnealing(1E11, .08, hcp);
                ...
                start = System.nanoTime();
                StandardGeneticAlgorithm ga = new StandardGeneticAlgorithm(40, 24, 8, gap);
                ...
                start = System.nanoTime();
                MIMIC mimic = new MIMIC(40, 20, pop);
